...
export default class Education extends Component<{ data: object }> {
  render() {
      ...
      <section>
        ...
        <AnchoredHeader level="3" id="relevant-courses">
          ...
          <small>
            ...
            {relevantCourses.length} courses on software, entrepreneurship,
            leadership and self development with a total of ~
            {relevantCoursesTotalDuration} hours
          </small>
        </AnchoredHeader>
        ...
        <AnchoredHeader level="3" id="relevant-events">
          ...
          <small>
            <FontAwesomeIcon icon={faCommentDots} flip="horizontal" />
            {relevantEvents.length} events on technology and entrepreneurship in
